      ...
      <Modal visible={bossOpen} transparent animationType="fade">
        <View style={styles.modalBackdrop}>
          <View style={styles.modalCard}>
            ...
            <Text style={styles.bossText}>{formatInt(bossHp)} / {formatInt(bossMaxHp)} HP</Text>
        ...
        <Modal visible={bossOpen} transparent animationType="fade">
          <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.7)', justifyContent: 'center', padding: 18 }}>
            <View style={{ backgroundColor: '#111827', borderRadius: 16, padding: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.12)' }}>
              ...
              <Text style={{ color: '#fff', marginTop: 8, fontWeight: '800' }}>{formatInt(bossHp)} / {formatInt(bossMaxHp)} HP</Text>

              <Text style={{ color: '#cfcfcf', marginTop: 8 }}>DPS: {dps.toFixed(2)} • Tier: {tier.value} • Monuments: {monuments.value}</Text>
